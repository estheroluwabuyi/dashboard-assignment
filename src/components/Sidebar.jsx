      ...
      <nav className="">
        <div>
          ...
          {menu.map((item, index) => {
            ...
            return (
              <div key={index} className="px-5 flex flex-col justify-center">
                <div
                  className={`font-medium flex items-center gap-3 w-50 pl-5 py-3 ${item.active ? "text-purple bg-[#707FDD]/10 rounded-[5px] " : "text-[#273240]"}`}
                >
                  <Icon
                    size={18}
                    className={`${item.active ? "" : "text-[#A6ABC8]"}`}
                  />
